...
public class PMCTS_Einstein {
    ...
    public void play() {// ゲームの手順
        ...
        rollDice();// サイコロを振る
        if (turn == 2) {
            int bestMove = selectMoveForPlayer2(); // PMCTSを用いてplayer2の手を選択
...
////////// ここから追加 ///////////
    ...
    public int selectMoveForPlayer2() {
        int bestMove = -1;
    ...
    private double simulateMove(int move) {
        int wins = 0;
        int simulations = 50; // シミュレーションの回数
        ...
        double WinRate = wins / simulations;
